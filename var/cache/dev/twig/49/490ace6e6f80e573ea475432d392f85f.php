...
class __TwigTemplate_b4cb51351a15b82602d1a00b0060365a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"row\">
        ...
        echo "\" class=\"btn btn-light \">Fiche Marque</a>
            <a href=\" ";
        // line 33
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_seller", ["seller_id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 33, $this->source); })()), "brand", [], "any", false, false, false, 33), "client", [], "any", false, false, false, 33), "id", [], "any", false, false, false, 33)]), "html", null, true);
...
";
    ...
    {
        return array (  167 => 34,  163 => 33,  159 => 32,  149 => 27,  143 => 24,  138 => 22,  130 => 19,  123 => 15,  119 => 14,  113 => 11,  107 => 10,  99 => 9,  95 => 8,  92 => 7,  82 => 6,  69 => 3,  59 => 2,  36 => 1,);
    }
